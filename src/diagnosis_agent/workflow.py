...
from diagnosis_agent.logging_config import LOGGER
...
def build_workflow():
    ...
    graph.add_node("rag_retrieve_and_generate", rag_retrieve_and_generate)
    graph.add_node("model_diagnosis", model_diagnosis)
    ...
    graph.add_edge("get_user_input", "rag_retrieve_and_generate")
    graph.add_edge("rag_retrieve_and_generate", "model_diagnosis")
